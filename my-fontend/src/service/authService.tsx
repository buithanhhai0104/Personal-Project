...
export const apiLogin = async (loginData: ILoginData) => {
  try {
    const response = await axios.post(
      "https://server-personal-project.vercel.app/auth/login",
      loginData,
      {
...
export const apiRegister = async (registerData: IRegisterData) => {
  try {
    const respone = await axios.post(
      "https://server-personal-project.vercel.app/auth/register",
      registerData,
      {
        withCredentials: true,
      }
...
export const apiLogout = async () => {
  try {
    const respone = await axios.post(
      "https://server-personal-project.vercel.app/auth/logout",
      {},
      {
        withCredentials: true,
      }
...
export const getUser = async () => {
  try {
    const response = await axios.get(
      "https://server-personal-project.vercel.app/userinfo",
      {
        withCredentials: true,
      }
    );
